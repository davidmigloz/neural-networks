...
Hemos procedido a buscar datos reales para probar la calidad real de la red mejor entrenada que hemos conseguido. Hemos comprobado que no había conjuntos de datos facilmente accesibles que usen los mismos parametros que los usados en el Thyroid\_dataset, actualmente por ejemplo se disgregan mujeres y hombres
